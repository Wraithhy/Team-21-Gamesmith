            ...
            <form action="{{ route('contact-form.store') }}" method="post">
                ...
                <div class="input-row">
                    ...
                    <div class="contact-info">
                        ...
                        <input id="Phone" name="phone" type="text" placeholder="+44 123 456 789 ">
                    </div>
                </div>
                <div class="input-row">
                    <div class="contact-info">
                ...
                <div class="input-row">
                    ...
                    <div class="contact-info">
                        <input id="html" type="checkbox"  name="contactPref[]" value="email">
                        <label for="html">Email</label><br>
                    </div>
                    <div class="contact-info">
                        <input id="css" type="checkbox"  name="contactPref[]" value="phone">
